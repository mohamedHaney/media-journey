...
export default function DashboardComp() {
  ...
  useEffect(() => {
    const fetchUsers = async () => {
      try {
        const res = await fetch('https://mediajourney1-holewhpc.b4a.run/api/user/getusers?limit=5');
    ...
    const fetchPosts = async () => {
      try {
        const res = await fetch('https://mediajourney1-holewhpc.b4a.run/api/post/getposts?limit=5');
        const data = await res.json();
        if (res.ok) {
          setPosts(data.posts);
    ...
    const fetchComments = async () => {
      try {
        const res = await fetch('https://mediajourney1-holewhpc.b4a.run/api/comment/getcomments?limit=5');
        const data = await res.json();
        if (res.ok) {
      ...
      <div className='flex-wrap flex gap-4 justify-center'>
        <div className='flex flex-col p-3 dark:bg-slate-800 gap-4 md:w-72 w-full rounded-md shadow-md'>
          <div className='flex justify-between'>
            <div className=''>
              <h3 className='text-gray-500 text-md uppercase'>عدد المستخدمين</h3>
        ...
        <div className='flex flex-col p-3 dark:bg-slate-800 gap-4 md:w-72 w-full rounded-md shadow-md'>
          <div className='flex justify-between'>
            <div className=''>
              <h3 className='text-gray-500 text-md uppercase'>عدد المواضيع</h3>
