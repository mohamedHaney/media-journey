...
export default function DashProfile() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch(`https://mediajourney1-holewhpc.b4a.run/api/user/update/${currentUser._id}`, {
        method: 'PUT',
        headers: {
  ...
  const handleDeleteUser = async () => {
    ...
    try {
      ...
      const res = await fetch(`https://mediajourney1-holewhpc.b4a.run/api/user/delete/${currentUser._id}`, {
        method: 'DELETE',
      });
      const data = await res.json();
      if (!res.ok) {
  ...
  const handleSignout = async () => {
    try {
      const res = await fetch('https://mediajourney1-holewhpc.b4a.run/api/user/signout', {
        method: 'POST',
      });
      const data = await res.json();
      if (!res.ok) {
